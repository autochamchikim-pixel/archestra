 ...
 * `mcpRegistry:read`: Browse the MCP server registry
 */
export const listMcpPresetEntries = <ThrowOnError extends boolean = false>(options?: Options<ListMcpPresetEntriesData, ThrowOnError>) => (options?.client ?? client).get<ListMcpPresetEntriesResponses, ListMcpPresetEntriesErrors, ThrowOnError>({ url: '/api/organization/mcp-preset-entries', ...options });
 ...
 * `mcpServerInstallation:admin`: Approve or manage all MCP server installations
 */
export const updateMcpPresetEntry = <ThrowOnError extends boolean = false>(options: Options<UpdateMcpPresetEntryData, ThrowOnError>) => (options.client ?? client).patch<UpdateMcpPresetEntryResponses, UpdateMcpPresetEntryErrors, ThrowOnError>({
 ...
 * `mcpServerInstallation:admin`: Approve or manage all MCP server installations
 */
export const updatePresetEntityDefaultLabel = <ThrowOnError extends boolean = false>(options: Options<UpdatePresetEntityDefaultLabelData, ThrowOnError>) => (options.client ?? client).patch<UpdatePresetEntityDefaultLabelResponses, UpdatePresetEntityDefaultLabelErrors, ThrowOnError>({
 ...
 * `mcpServerInstallation:admin`: Approve or manage all MCP server installations
 */
export const updatePresetEntityDefaultValidationRegex = <ThrowOnError extends boolean = false>(options: Options<UpdatePresetEntityDefaultValidationRegexData, ThrowOnError>) => (options.client ?? client).patch<UpdatePresetEntityDefaultValidationRegexResponses, UpdatePresetEntityDefaultValidationRegexErrors, ThrowOnError>({
